...
from PyQt6.QtCore import (QSize, Qt, QThread, QObject, pyqtSignal, pyqtSlot,
                          QMutex, QMutexLocker, QMetaObject, QRunnable, QThreadPool) # Added QRunnable, QThreadPool
# Remove duplicate import line below if present (was line 8)
...
class BatchFilmstripWidget(QWidget):
    ...
    def __init__(self, parent=None):
        super().__init__(parent)
        self.thumbnail_size = QSize(100, 100) # Store target size
