...
class PhotoPresetPanel(QWidget):
    ...
    def trigger_preview(self):
        ...
        if self.current_preset_id:
            ...
            self.preview_requested.emit(current_image, 'photo', self.current_preset_id, self.intensity)
        else:
            ...
            self.preview_requested.emit(current_image, None, None, 0.0)
        ...
        if self.current_preset_id:
            ...
            if hasattr(main_window, 'get_current_image_for_processing'):
                 ...
                 if current_image is not None:
                    # Emit signal with type 'photo'
                    self.apply_requested.emit(current_image, 'photo', self.current_preset_id, self.intensity)
                 else:
